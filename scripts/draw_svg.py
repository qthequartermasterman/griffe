...
d.append(draw.Arc(60, 20, 20, 90, -60, cw=True, stroke="green", stroke_width=3, fill="none"))
d.append(draw.Arc(60, 20, 20, -60, 90, cw=False, stroke="blue", stroke_width=1, fill="black", fill_opacity=0.3))
...
d.append(p)
d.append(
    draw.Line(30, 20, 0, 10, stroke="red", stroke_width=2, fill="none", marker_end=arrow),
